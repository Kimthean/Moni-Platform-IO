...
#define LV_MEM_CUSTOM_REALLOC ps_realloc /*Wrapper to realloc*/
#endif                                   /*LV_MEM_CUSTOM*/
 ...
 *LV_DITHER_GRADIENT implies LV_GRADIENT_MAX_STOPS = 256 by default. (needs 8 bits)
 *LV_DITHER_GRADIENT = 1 for dithering, 0 to disable*/
 ...
 *If LV_USE_ASSERT_NULL is enabled an error message will be printed on failure*/
...
#define LV_USE_ASSERT_OBJ 0           /*Check if the used object is valid. (Slow)*/
